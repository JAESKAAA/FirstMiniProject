...
public class Person {
	...
	// map에 String id가 키값으로 들어가고, Person클래스가 맵으로 들어가게 됨
	// account의 경우 댓글을 남기기 위한 맵 자료구조로, 키값에 String id가 들어가고, 벨류값에 작성한 코멘트가 들어가게됨
...
//		String nickName = sc.nextLine();
	...
	public static void showComment2(int is_review) {
		...
		if (is_review == 1) {
			...
			switch (FTPClient.musicSelect) {
			case 1:
				song.setSongName(s);
				Song.song1.add(song);
				for (Song a1 : Song.song1) {
